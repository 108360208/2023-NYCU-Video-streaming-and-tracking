...
def bbox_ioa(box1, box2, iou=False, eps=1e-7):
    ...
    # print(np.minimum(b1_x2[:, None], b2_x2))
    # Intersection area
    ...
    if iou:
        ...
        # print(area)
        # print(box1_area[:, None])
        # print(area + box1_area[:, None])
        area = area + box1_area[:, None] - inter_area
        iou = inter_area / (area + eps)
    center_distance = ((b2_center_x - b1_center_x[:,None])**2 + (b2_center_y - b1_center_y[:,None])**2) / np.maximum(1e-7, area)
    diagonal_distance = (np.maximum(b1_x2[:,None], b2_x2) - np.minimum(b1_x1[:,None], b2_x1))**2 + (np.maximum(b1_y2[:,None], b2_y2) - np.minimum(b1_y1[:,None], b2_y1))**2
    # print(center_distance)
    # print(diagonal_distance)
        
    diou = iou - center_distance / (diagonal_distance + eps)
    # print(diou)
    # print("iou")
    # print(iou)
    # Intersection over box2 area
    return iou - center_distance / np.maximum(diagonal_distance , eps)
